...
<spring:url value="/evento/" var="evento2"></spring:url>
...
<link href='<spring:url value="/resources/css/styles5.css" />'
	rel="stylesheet" />
<link rel="stylesheet"
...
<body>
	...
	<header class="masthead">
		<nav class="navbar navbar-expand-lg navbar-light fixed-top py-3"
			id="mainNav">
			<div class="container">
				<a class="navbar-brand js-scroll-trigger" href="${home}">EV3NT0S</a>
				...
				<div class="collapse navbar-collapse" id="navbarResponsive">
					<ul class="navbar-nav ml-auto my-2 my-lg-0">
						<li class="nav-item active"><a
							class="nav-link js-scroll-trigger" href="${home}">Home</a></li>
						<li class="nav-item"><a class="nav-link js-scroll-trigger"
							href="${cliente}">Clientes</a></li>
						<li class="nav-item"><a class="nav-link js-scroll-trigger"
							href="${casaDeShow}">Casas De Show</a></li>
						<li class="nav-item"><a class="nav-link js-scroll-trigger"
							href="${evento2}">Eventos</a></li>
					</ul>
				</div>
			</div>
		</nav>
	...
	<main>
		<div class="container mt-3">
			<div class="row justify-content-center mx-auto text-center mt-5">
				<div
					class="col-lg-6 justify-content-center mx-auto text-center mb-4">
					<div class="card h100 mx-auto text-center">
						<img class="img-thumbnail"
							src="data:image/jpge;base64,${evento.imagemEncoded }"
							alt="Imagem nao encontrada" />
						<div class="card-body">
							<h4 class="card-title">
								<a href="${detalhe}${evento.codigo}"><input type="hidden"
									name="oi" value="${evento.codigo}">${evento.nome}</a>
							</h4>
							<h5>R$ ${evento.preco}</h5>
							<h6>${evento.descricao}</h6>
							<form action="${comprar}">
								<input type="hidden" name="codigoEvento" value="${evento.codigo}">
								<label>Quantidade de Ingressos:</label>
								<input type="number" name="quantidade" min='1' max='4' class="form-control">
						...
						<!--  <div class="card-body">
									<h4 class="card-title">
										<a href="${detalhe}${evento.codigo}"><input type="submit"
											name="oi" value="${evento.codigo}">${evento.nome}</a>
									</h4>
									<h5>R$ ${evento.preco}</h5>
								</div>
